...
import com.orange.dgil.DgilView;
...
public class MainActivity extends AppCompatActivity {
    ...
    private DgilAndroid dgilAndroid;
    private DgilView dgilView;
    private ArrayAdapter listAdapter;
    private InputStream modelParameters;
    public SearchView mshFilter;
    ...
    MainActivity(Object[] objArr, InstantReloadException instantReloadException) {
        switch (((String) objArr[0]).hashCode()) {
            ...
            case 155484467:
                ...
                return;
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[0], Integer.valueOf(((String) objArr[0]).hashCode()), "com/orangelabs/simplefiltering/MainActivity"}));
        }
    }
    ...
    public static /* synthetic */ Object access$super(MainActivity mainActivity, String str, Object... objArr) {
        switch (str.hashCode()) {
            ...
            case -1310462796:
                return super.dispatchFragmentsOnCreateView((View) objArr[0], (String) objArr[1], (Context) objArr[2], (AttributeSet) objArr[3]);
            case -1291272994:
            ...
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/orangelabs/simplefiltering/MainActivity"}));
        }
    }

    private DgilListener createMSHListener() {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            return (DgilListener) incrementalChange.access$dispatch("createMSHListener.()Lcom/orange/dgil/callback/DgilListener;", new Object[]{this});
        }
        try {
            return new MyMshListener(this.dgilAndroid, this.mshFilter);
        } catch (IOException e) {
            String err = "Failed to load models asset file: " + e.getMessage();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C0368R.layout.activity_main);
        setSupportActionBar((android.support.v7.widget.Toolbar) findViewById(C0368R.id.toolbar));
        this.dgilView = (DgilView) findViewById(C0368R.id.dgil_view);
        this.dgilAndroid = this.dgilView.getDgil();
        ListView myContactView = (ListView) findViewById(C0368R.id.my_list_view);
        this.listAdapter = new ArrayAdapter(this, 17367043, new ContactList().getContactList());
        myContactView.setAdapter(this.listAdapter);
        this.mshFilter = (SearchView) findViewById(C0368R.id.msh_filter);
        this.mshFilter.setOnQueryTextListener(new MyFilterListener(this.listAdapter));
        this.mshFilter.setIconifiedByDefault(false);
        this.dgilAndroid.setListener(createMSHListener());
    }

    public boolean onCreateOptionsMenu(Menu menu) {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange != null) {
            return ((Boolean) incrementalChange.access$dispatch("onCreateOptionsMenu.(Landroid/view/Menu;)Z", new Object[]{this, menu})).booleanValue();
        }
        getMenuInflater().inflate(C0368R.menu.menu_main, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        IncrementalChange incrementalChange = $change;
        if (incrementalChange == null) {
            return item.getItemId() != C0368R.id.action_settings ? super.onOptionsItemSelected(item) : true;
        } else {
            return ((Boolean) incrementalChange.access$dispatch("onOptionsItemSelected.(Landroid/view/MenuItem;)Z", new Object[]{this, item})).booleanValue();
        }
    }
    ...
    public MainActivity() {
        ...
        if (incrementalChange != null) {
            incrementalChange.access$dispatch("init$body.(Lcom/orangelabs/simplefiltering/MainActivity;)V", new Object[]{this});
            return;
        }
