...
public class EpisodeHistory extends ArrayList<GestureEpisode> {
    public static volatile transient /* synthetic */ IncrementalChange $change;

    EpisodeHistory(Object[] objArr, InstantReloadException instantReloadException) {
        switch (((String) objArr[0]).hashCode()) {
            ...
            case -511850385:
                ...
                return;
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{(String) objArr[0], Integer.valueOf(((String) objArr[0]).hashCode()), "com/orangelabs/simplefiltering/EpisodeHistory"}));
        }
    }

    public static /* synthetic */ Object access$super(EpisodeHistory episodeHistory, String str, Object... objArr) {
        switch (str.hashCode()) {
            case -2146825139:
            ...
            case 2025021518:
                return super.clone();
            default:
                throw new InstantReloadException(String.format("String switch could not find '%s' with hashcode %s in %s", new Object[]{str, Integer.valueOf(str.hashCode()), "com/orangelabs/simplefiltering/EpisodeHistory"}));
        }
    }
    ...
    public EpisodeHistory() {
        ...
        if (incrementalChange != null) {
            incrementalChange.access$dispatch("init$body.(Lcom/orangelabs/simplefiltering/EpisodeHistory;)V", new Object[]{this});
        }
    }
}
