...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C02101();
    ...
    private final Runnable mSetIdleRunnable = new C02112();
    ...
    private void releaseViewForPointerUp() {
        this.mVelocityTracker.computeCurrentVelocity(DefaultDrawerConf.QUILL_HEIGHT_UM, this.mMaxVelocity);
