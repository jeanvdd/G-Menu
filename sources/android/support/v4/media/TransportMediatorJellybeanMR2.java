...
class TransportMediatorJellybeanMR2 {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C03434();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final OnGetPlaybackPositionListener mGetPlaybackPositionListener = new C03445();
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C03423();
    PendingIntent mPendingIntent;
    int mPlayState = 0;
    final OnPlaybackPositionUpdateListener mPlaybackPositionUpdateListener = new C03456();
    final String mReceiverAction;
    final IntentFilter mReceiverFilter;
    RemoteControlClient mRemoteControl;
    final View mTargetView;
    final TransportMediatorCallback mTransportCallback;
    final OnWindowAttachListener mWindowAttachListener = new C03401();
    final OnWindowFocusChangeListener mWindowFocusListener = new C03412();

    /* renamed from: android.support.v4.media.TransportMediatorJellybeanMR2$1 */
    class C03401 implements OnWindowAttachListener {
        C03401() {
        }
    ...
    class C03412 implements OnWindowFocusChangeListener {
        C03412() {
        }
    ...
    class C03423 extends BroadcastReceiver {
        C03423() {
        }
    ...
    class C03434 implements OnAudioFocusChangeListener {
        C03434() {
        }
    ...
    class C03445 implements OnGetPlaybackPositionListener {
        C03445() {
        }
    ...
    class C03456 implements OnPlaybackPositionUpdateListener {
        C03456() {
        }
