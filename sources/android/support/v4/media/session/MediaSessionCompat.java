...
public class MediaSessionCompat {
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C01511();
        private VolumeProviderCompat mVolumeProvider;
        private int mVolumeType;

        /* renamed from: android.support.v4.media.session.MediaSessionCompat$MediaSessionImplBase$1 */
        class C01511 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C01511() {
            }
        ...
        class C01522 implements android.support.v4.media.session.MediaSessionCompatApi19.Callback {
            C01522() {
            }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            android.support.v4.media.session.MediaSessionCompatApi19.Callback cb19 = new C01522();
            if (VERSION.SDK_INT >= 18) {
    ...
    public static final class QueueItem implements Parcelable {
        public static final Creator<QueueItem> CREATOR = new C01531();
        ...
        static class C01531 implements Creator<QueueItem> {
            C01531() {
            }
        ...
        public static QueueItem obtain(Object queueItem) {
            return new QueueItem(queueItem, MediaDescriptionCompat.fromMediaDescription(android.support.v4.media.session.MediaSessionCompatApi21.QueueItem.getDescription(queueItem)), android.support.v4.media.session.MediaSessionCompatApi21.QueueItem.getQueueId(queueItem));
        }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        public static final Creator<ResultReceiverWrapper> CREATOR = new C01541();
        private ResultReceiver mResultReceiver;

        /* renamed from: android.support.v4.media.session.MediaSessionCompat$ResultReceiverWrapper$1 */
        static class C01541 implements Creator<ResultReceiverWrapper> {
            C01541() {
            }
    ...
    public static final class Token implements Parcelable {
        public static final Creator<Token> CREATOR = new C01551();
        private final Object mInner;

        /* renamed from: android.support.v4.media.session.MediaSessionCompat$Token$1 */
        static class C01551 implements Creator<Token> {
            C01551() {
            }
