...
public class TransportMediator extends TransportController {
    ...
    class C01461 implements TransportMediatorCallback {
        C01461() {
        }
    ...
    class C01472 implements Callback {
        C01472() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C01461();
        this.mKeyEventCallback = new C01472();
