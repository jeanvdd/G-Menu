...
public class ViewPager extends ViewGroup {
    ...
    static class C01761 implements Comparator<ItemInfo> {
        C01761() {
        }
    ...
    static class C01772 implements Interpolator {
        C01772() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C01801 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C01801() {
            }
        ...
        switch (ev.getAction() & 255) {
            ...
            case 1:
                if (this.mIsBeingDragged) {
                    ...
                    velocityTracker.computeCurrentVelocity(DefaultDrawerConf.QUILL_HEIGHT_UM, (float) this.mMaximumVelocity);
