...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C01092();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C01081();
    ...
    class C01092 implements OnItemClickListener {
        C01092() {
        }
