...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C01161();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C01172();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    static class C01161 implements ThreadFactory {
    ...
    class C01172 extends WorkerRunnable<Params, Result> {
        C01172() {
            super();
        }
