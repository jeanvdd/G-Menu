...
class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    public ShadowDrawableWrapper(Resources resources, Drawable content, float radius, float shadowSize, float maxShadowSize) {
        super(content);
        this.mShadowStartColor = resources.getColor(C0369R.color.design_fab_shadow_start_color);
        this.mShadowMiddleColor = resources.getColor(C0369R.color.design_fab_shadow_mid_color);
        this.mShadowEndColor = resources.getColor(C0369R.color.design_fab_shadow_end_color);
    ...
    private void buildShadowCorners() {
        ...
        this.mEdgeShadowPaint.setShader(new LinearGradient(0.0f, innerBounds.top, 0.0f, outerBounds.top, new int[]{this.mShadowStartColor, this.mShadowMiddleColor, this.mShadowEndColor}, new float[]{0.0f, 0.5f, SHADOW_BOTTOM_SCALE}, TileMode.CLAMP));
        this.mEdgeShadowPaint.setAntiAlias(false);
    }
