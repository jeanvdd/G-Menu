...
public class AppBarLayout extends LinearLayout {
    ...
    class C00391 implements OnApplyWindowInsetsListener {
        C00391() {
        }
    ...
    public static class LayoutParams extends android.widget.LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            TypedArray a = c.obtainStyledAttributes(attrs, C0369R.styleable.AppBarLayout_LayoutParams);
            this.mScrollFlags = a.getInt(C0369R.styleable.AppBarLayout_LayoutParams_layout_scrollFlags, 0);
            if (a.hasValue(C0369R.styleable.AppBarLayout_LayoutParams_layout_scrollInterpolator)) {
                this.mScrollInterpolator = AnimationUtils.loadInterpolator(c, a.getResourceId(C0369R.styleable.AppBarLayout_LayoutParams_layout_scrollInterpolator, 0));
            }
            a.recycle();
        }
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0369R.styleable.ScrollingViewBehavior_Params);
            setOverlayTop(a.getDimensionPixelSize(C0369R.styleable.ScrollingViewBehavior_Params_behavior_overlapTop, 0));
            a.recycle();
        }
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0369R.styleable.AppBarLayout, 0, C0369R.style.Widget_Design_AppBarLayout);
        this.mTargetElevation = (float) a.getDimensionPixelSize(C0369R.styleable.AppBarLayout_elevation, 0);
        setBackgroundDrawable(a.getDrawable(C0369R.styleable.AppBarLayout_android_background));
        if (a.hasValue(C0369R.styleable.AppBarLayout_expanded)) {
            setExpanded(a.getBoolean(C0369R.styleable.AppBarLayout_expanded, false));
        }
        a.recycle();
        ViewUtils.setBoundsViewOutlineProvider(this);
        this.mListeners = new ArrayList();
        ViewCompat.setElevation(this, this.mTargetElevation);
        ViewCompat.setOnApplyWindowInsetsListener(this, new C00391());
    }
