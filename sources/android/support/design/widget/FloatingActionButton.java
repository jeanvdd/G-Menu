...
public class FloatingActionButton extends VisibilityAwareImageButton {
    ...
    public FloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0369R.styleable.FloatingActionButton, defStyleAttr, C0369R.style.Widget_Design_FloatingActionButton);
        this.mBackgroundTint = a.getColorStateList(C0369R.styleable.FloatingActionButton_backgroundTint);
        this.mBackgroundTintMode = parseTintMode(a.getInt(C0369R.styleable.FloatingActionButton_backgroundTintMode, -1), null);
        this.mRippleColor = a.getColor(C0369R.styleable.FloatingActionButton_rippleColor, 0);
        this.mSize = a.getInt(C0369R.styleable.FloatingActionButton_fabSize, 0);
        this.mBorderWidth = a.getDimensionPixelSize(C0369R.styleable.FloatingActionButton_borderWidth, 0);
        float elevation = a.getDimension(C0369R.styleable.FloatingActionButton_elevation, 0.0f);
        float pressedTranslationZ = a.getDimension(C0369R.styleable.FloatingActionButton_pressedTranslationZ, 0.0f);
        this.mCompatPadding = a.getBoolean(C0369R.styleable.FloatingActionButton_useCompatPadding, false);
        a.recycle();
        this.mImagePadding = (getSizeDimension() - ((int) getResources().getDimension(C0369R.dimen.design_fab_image_size))) / 2;
    ...
    final int getSizeDimension() {
        switch (this.mSize) {
            case 1:
                return getResources().getDimensionPixelSize(C0369R.dimen.design_fab_size_mini);
            default:
                return getResources().getDimensionPixelSize(C0369R.dimen.design_fab_size_normal);
        }
    }
