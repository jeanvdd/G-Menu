...
public class TextInputLayout extends LinearLayout {
    ...
    class C00751 implements TextWatcher {
        C00751() {
        }
    ...
    class C00762 extends ViewPropertyAnimatorListenerAdapter {
        C00762() {
        }
    ...
    class C00784 implements AnimatorUpdateListener {
        C00784() {
        }
    ...
    static class SavedState extends BaseSavedState {
        ...
        static class C00791 implements Creator<SavedState> {
            C00791() {
            }
    ...
    public TextInputLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0369R.styleable.TextInputLayout, defStyleAttr, C0369R.style.Widget_Design_TextInputLayout);
        this.mHintEnabled = a.getBoolean(C0369R.styleable.TextInputLayout_hintEnabled, true);
        setHint(a.getText(C0369R.styleable.TextInputLayout_android_hint));
        this.mHintAnimationEnabled = a.getBoolean(C0369R.styleable.TextInputLayout_hintAnimationEnabled, true);
        if (a.hasValue(C0369R.styleable.TextInputLayout_android_textColorHint)) {
            ColorStateList colorStateList = a.getColorStateList(C0369R.styleable.TextInputLayout_android_textColorHint);
            this.mFocusedTextColor = colorStateList;
            this.mDefaultTextColor = colorStateList;
        }
        if (a.getResourceId(C0369R.styleable.TextInputLayout_hintTextAppearance, -1) != -1) {
            setHintTextAppearance(a.getResourceId(C0369R.styleable.TextInputLayout_hintTextAppearance, 0));
        }
        this.mErrorTextAppearance = a.getResourceId(C0369R.styleable.TextInputLayout_errorTextAppearance, 0);
        boolean errorEnabled = a.getBoolean(C0369R.styleable.TextInputLayout_errorEnabled, false);
        boolean counterEnabled = a.getBoolean(C0369R.styleable.TextInputLayout_counterEnabled, false);
        setCounterMaxLength(a.getInt(C0369R.styleable.TextInputLayout_counterMaxLength, -1));
        this.mCounterTextAppearance = a.getResourceId(C0369R.styleable.TextInputLayout_counterTextAppearance, 0);
        this.mCounterOverflowTextAppearance = a.getResourceId(C0369R.styleable.TextInputLayout_counterOverflowTextAppearance, 0);
        a.recycle();
    ...
    private void setEditText(EditText editText) {
        ...
        this.mEditText.addTextChangedListener(new C00751());
        ...
        if (this.mErrorEnabled != enabled) {
            ...
            if (enabled) {
                ...
                try {
                    ...
                    this.mErrorView.setTextAppearance(getContext(), C0369R.style.TextAppearance_AppCompat_Caption);
                    this.mErrorView.setTextColor(ContextCompat.getColor(getContext(), C0369R.color.design_textinput_error_color_light));
                }
        ...
        if (!TextUtils.equals(this.mError, error)) {
            ...
            if (this.mErrorShown) {
                ...
                if (animate) {
                    ...
                    ViewCompat.animate(this.mErrorView).alpha(1.0f).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new C00762()).start();
                }
        ...
        if (this.mCounterEnabled != enabled) {
            if (enabled) {
                ...
                try {
                    ...
                    this.mCounterView.setTextAppearance(getContext(), C0369R.style.TextAppearance_AppCompat_Caption);
                    this.mCounterView.setTextColor(ContextCompat.getColor(getContext(), C0369R.color.design_textinput_error_color_light));
                }
    ...
    private void updateCounter(int length) {
        ...
        if (this.mCounterMaxLength == -1) {
            ...
            this.mCounterView.setText(getContext().getString(C0369R.string.character_counter_pattern, new Object[]{Integer.valueOf(length), Integer.valueOf(this.mCounterMaxLength)}));
        }
    ...
    private void animateToExpansionFraction(float target) {
        if (this.mCollapsingTextHelper.getExpansionFraction() != target) {
            if (this.mAnimator == null) {
                ...
                this.mAnimator.setUpdateListener(new C00784());
            }
