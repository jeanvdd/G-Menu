...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    class C00481 implements Comparator<View> {
        C00481() {
        }
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C0369R.styleable.CoordinatorLayout_LayoutParams);
            this.gravity = a.getInteger(C0369R.styleable.CoordinatorLayout_LayoutParams_android_layout_gravity, 0);
            this.mAnchorId = a.getResourceId(C0369R.styleable.CoordinatorLayout_LayoutParams_layout_anchor, -1);
            this.anchorGravity = a.getInteger(C0369R.styleable.CoordinatorLayout_LayoutParams_layout_anchorGravity, 0);
            this.keyline = a.getInteger(C0369R.styleable.CoordinatorLayout_LayoutParams_layout_keyline, -1);
            this.mBehaviorResolved = a.hasValue(C0369R.styleable.CoordinatorLayout_LayoutParams_layout_behavior);
            if (this.mBehaviorResolved) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attrs, a.getString(C0369R.styleable.CoordinatorLayout_LayoutParams_layout_behavior));
            }
            a.recycle();
        }
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mLayoutDependencyComparator = new C00481();
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0369R.styleable.CoordinatorLayout, defStyleAttr, C0369R.style.Widget_Design_CoordinatorLayout);
        int keylineArrayRes = a.getResourceId(C0369R.styleable.CoordinatorLayout_keylines, 0);
        ...
        this.mStatusBarBackground = a.getDrawable(C0369R.styleable.CoordinatorLayout_statusBarBackground);
        a.recycle();
