...
public class BottomSheetBehavior<V extends View> extends Behavior<V> {
    ...
    private final Callback mDragCallback = new C00421();
    ...
    protected static class SavedState extends BaseSavedState {
        ...
        static class C00431 implements Creator<SavedState> {
            C00431() {
            }
    ...
    public BottomSheetBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, C0369R.styleable.BottomSheetBehavior_Params);
        setPeekHeight(a.getDimensionPixelSize(C0369R.styleable.BottomSheetBehavior_Params_behavior_peekHeight, 0));
        setHideable(a.getBoolean(C0369R.styleable.BottomSheetBehavior_Params_behavior_hideable, false));
        a.recycle();
    ...
    private boolean shouldHide(View child, float yvel) {
        if (child.getTop() >= this.mMaxOffset && Math.abs((((float) child.getTop()) + (HIDE_FRICTION * yvel)) - ((float) this.mMaxOffset)) / ((float) this.mPeekHeight) > 0.5f) {
            return true;
        }
        return false;
    }
    ...
    private float getYVelocity() {
        this.mVelocityTracker.computeCurrentVelocity(DefaultDrawerConf.QUILL_HEIGHT_UM, this.mMaximumVelocity);
