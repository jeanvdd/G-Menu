...
public class StaggeredGridLayoutManager extends LayoutManager {
    ...
    private final Runnable mCheckForGapsRunnable = new C02491();
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            public static final Creator<FullSpanItem> CREATOR = new C02511();
            int mGapDir;
            int[] mGapPerSpan;
            ...
            static class C02511 implements Creator<FullSpanItem> {
                C02511() {
                }
