...
import android.support.v7.recyclerview.C0367R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    private static final Interpolator sQuinticInterpolator = new C02433();
    ...
    public static abstract class LayoutManager {
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0367R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0367R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0367R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0367R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0367R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    static class C02433 implements Interpolator {
        C02433() {
        }
    ...
    class C02444 implements ProcessCallback {
        C02444() {
        }
    ...
    class C02455 implements Callback {
        C02455() {
        }
    ...
    class C02466 implements Callback {
        C02466() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C02471 implements Creator<SavedState> {
            C02471() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C02411();
        ...
        this.mItemAnimatorRunner = new C02422();
        this.mViewInfoProcessCallback = new C02444();
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0367R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a.getString(C0367R.styleable.RecyclerView_layoutManager);
            a.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C02455());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C02466());
    }
