...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C02851();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C02862();
    private boolean mShowingForMode;
    private ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C02873();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$1 */
    class C02851 extends ViewPropertyAnimatorListenerAdapter {
        C02851() {
        }
    ...
    class C02862 extends ViewPropertyAnimatorListenerAdapter {
        C02862() {
        }
    ...
    class C02873 implements ViewPropertyAnimatorUpdateListener {
        C02873() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0370R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0370R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0370R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0370R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0370R.styleable.ActionBar, C0370R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0370R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0370R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0370R.attr.actionBarWidgetTheme, outValue, true);
