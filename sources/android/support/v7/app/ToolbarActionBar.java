...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C02832();
    private final Runnable mMenuInvalidator = new C02821();
    ...
    class C02832 implements OnMenuItemClickListener {
        C02832() {
        }
...
Error: jadx.core.utils.exceptions.JadxRuntimeException: Can't find block by offset: 0x0030 in list [B:12:0x002d]
	...
	at jadx.api.JadxDecompiler$$Lambda$8/849373393.run(Unknown Source)
*/
        /*
        r5 = this;
        r0 = 0;
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(context2, C0370R.layout.abc_list_menu_item_layout);
