...
public abstract class StdDeserializer<T> extends JsonDeserializer<T> {
    ...
    /* renamed from: org.codehaus.jackson.map.deser.std.StdDeserializer$1 */
    static /* synthetic */ class C00261 {
        static final /* synthetic */ int[] $SwitchMap$org$codehaus$jackson$JsonParser$NumberType = new int[NumberType.values().length];
    ...
    public static class BigIntegerDeserializer extends StdScalarDeserializer<BigInteger> {
        ...
        public BigInteger deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
            ...
            if (t == JsonToken.VALUE_NUMBER_INT) {
                switch (C00261.$SwitchMap$org$codehaus$jackson$JsonParser$NumberType[jp.getNumberType().ordinal()]) {
                    case 1:
                    case 2:
    ...
    public static final class NumberDeserializer extends StdScalarDeserializer<Number> {
        ...
        public Object deserializeWithType(JsonParser jp, DeserializationContext ctxt, TypeDeserializer typeDeserializer) throws IOException, JsonProcessingException {
            switch (C00261.$SwitchMap$org$codehaus$jackson$JsonToken[jp.getCurrentToken().ordinal()]) {
                case 1:
                case 2:
                case 3:
        ...
        if (t == JsonToken.VALUE_STRING) {
            ...
            try {
                ...
                if (len > 9) {
                    ...
                    throw ctxt.weirdStringException(this._valueClass, "Overflow: numeric value (" + text + ") out of range of int (" + Integer.MIN_VALUE + " - " + ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED + ")");
                } else if (len != 0) {
        ...
        if (t == JsonToken.VALUE_STRING) {
            ...
            try {
                ...
                if (len > 9) {
                    ...
                    throw ctxt.weirdStringException(this._valueClass, "Overflow: numeric value (" + text + ") out of range of Integer (" + Integer.MIN_VALUE + " - " + ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED + ")");
                } else if (len == 0) {
